package com.yangyl.manage.common.interceptor;

import com.yangyl.manage.utils.ClassUtil;
...
public class RequestLogAspect {
     ...
     */
    @Around(
            "execution(!static com.yangyl.manage.common.dto.Response *(..)) && " +
    ...
    public Object aroundApi(ProceedingJoinPoint point) throws Throwable {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            if (requestBody != null && value != null) {
                paraMap.putAll(CommonUtils.toMap(value));
                continue;
            }
            // 处理 List
        ...
        if (paraMap.isEmpty()) {
            ...
            beforeReqArgs.add(CommonUtils.toJson(paraMap));
        }
        // 打印请求头
        ...
        try {
            ...
            afterReqArgs.add(CommonUtils.toJson(result));
            return result;
        } finally {
